...
country = {
	...
	GOLD_TO_CASH_RATE = 4, -- Amount of money generated per gold unit #was 0.5
	GOLD_TO_WORKER_PAY_RATE = 2, -- Multiplier for how much money gold pays to pops #was 3.5
	...
	TECH_YEAR_SPAN = 140,
	TECH_FACTOR_VASSAL = 0.35, -- cost reduction factor if overlord has research the tech
	MAX_SUPPRESSION = 100,
...
economy = {
	...
	LOAN_BASE_INTEREST			= 0.07, --0.02
	BANKRUPTCY_EXTERNAL_LOAN_YEARS	= 10,
	BANKRUPTCY_FACTOR = 0.2,
	SHADOWY_FINANCIERS_MAX_LOAN_AMOUNT = 150000, --1500
	...
	CAPITALIST_BUILD_FACTORY_STATE_EMPLOYMENT_PERCENT = 0.1, -- Capis don't build factories if less than this percent is employed in existing factories was 0.7
	...
	SECOND_RANK_BASE_SHARE_FACTOR = 0.35, -- 0.5
	CIV_BASE_SHARE_FACTOR = 0.35, -- 0.75
	UNCIV_BASE_SHARE_FACTOR = 1,
	FACTORY_PAYCHECKS_LEFTOVER_FACTOR = 0.98, -- % of how much we pay to the pops and capitalists, from the leftovers. was 0.25
	MAX_FACTORY_MONEY_SAVE = 2500,	-- how much money is stored maximum in a factory. was 1000
	...
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_HI = 0.4,	-- how fast pops are Hired when there is a high demand was 0.2
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_LO = 0.1,	-- how fast pops are Hired when there is a medium demand was 0.02
...
military = {
	...
	LEADER_PRESTIGE_LAND_GAIN = 1.0, -- extra speed gain on prestige for land combat
	LEADER_PRESTIGE_NAVAL_GAIN = 1.0, -- extra speed gain on prestige for naval combat
	...
	AI_SUPPORT_PROPORTION = 1, -- fraction of brigades that should be artillery and other support units
	AI_SPECIAL_PROPORTION = 0.5, -- fraction of brigades that should be engineers and tanks
	...
	SIEGE_BRIGADES_BONUS = 0.7, -- the bonus to siege speed from each brigade ---------------------------------------------------------- WAS 0.5
	...
	NAVAL_LOW_SUPPLY_DAMAGE_MIN_STR = 10.0, -- when low supply, the navy will supply STR damage but no less then X% to avoid destruction (value from 0 to 100.0)
...
diplomacy = {
	...
	CRISIS_BASE_CHANCE = -10000, -- originally -20
	...
	RANK_1_TENSION_DECAY = -0.06, -- extra flashpoint tension decay for GPs
	RANK_2_TENSION_DECAY = -0.06,
	RANK_3_TENSION_DECAY = -0.06,
	RANK_4_TENSION_DECAY = -0.06,
	RANK_5_TENSION_DECAY = -0.05,
	RANK_6_TENSION_DECAY = -0.04,
...
ai =
{
	...
	PEACE_WAR_DIRECTION_FACTOR = 3, -- AI willingness to peace based on who's making gains in the war 					Was 1 but making it 2 seems to help stop pointless white peaces
	...
	AGGRESSION_BASE = 5, -- general AI aggression # was 5
	...
	MONTHS_BEFORE_DISBAND = 24, -- Months from start date before AI will disband armies/navies (to avoid disbands because of early economic turmoil) # was 6
},
